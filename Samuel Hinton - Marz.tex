...
After this variance adjustment, I divided the intensity spectrum by the variance spectrum. Prior software such as AutoZ and literature (Saunders \etal \cite{saunders2004improvements}) recommend dividing by variance, and this is done to the spectrum such that for all pixels, $s_i,\ s_i = s_i \cdot v_i$.
